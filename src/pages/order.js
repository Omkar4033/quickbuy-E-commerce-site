  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">QuickBuy</h2>
        ...
        <p class="leading-relaxed mb-4">Your Order has been placed sucessfully ! </p>
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900">₹1599</span>
